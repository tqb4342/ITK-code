...
Vector Vector::interpolate2(const Vector& midControl, const Vector& endControl, 
...
Vector Vector::interpolate3(const Vector& leftControl, const Vector& rightControl, 
			    const Vector& endControl, const double t) const
{
