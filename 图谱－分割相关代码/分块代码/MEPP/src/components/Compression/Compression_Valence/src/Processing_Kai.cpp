...
typedef Aff_transformation_3<Enriched_kernel> Affine_transformation;


// see Processing_Component.h for the effects of the following functions

void Processing_Component::NoiseAddition (Polyhedron *pMesh, Noise_type noiseType, double noiseIntensity, bool preserveBoundaries)
{
...
void Processing_Component::NoiseAdditionUniform (Polyhedron *pMesh, double noiseIntensity, bool preserveBoundaries)
{
...
void Processing_Component::NoiseAdditionGaussian (Polyhedron *pMesh, double noiseIntensity, bool preserveBoundaries)
{
	int numVertex = pMesh->size_of_vertices();;
	Vector centroid = Point3d(0,0,0) - CGAL::ORIGIN;
	double distancetoCentroid = 0.0;
...
void Processing_Component::LaplacianSmoothing (Polyhedron *pMesh, double deformFactor, int iteraNum, bool preserveBoundaries)
{
	Vertex_iterator	pVertex;
	int numVertex = pMesh->size_of_vertices();
...
void Processing_Component::CoordinateQuantization (Polyhedron *pMesh, int bitDepth)
{
	Vertex_iterator	pVertex;
...
void Processing_Component::Translation (Polyhedron *pMesh, double xTranslation, double yTranslation, double zTranslation)
{
...
void Processing_Component::Rotation (Polyhedron *pMesh, double xAxis, double yAxis, double zAxis, double angle)
{
...
void Processing_Component::UniformScaling (Polyhedron *pMesh, double scalingFactor)
{
...
void Processing_Component::Subdivision (Polyhedron *pMesh, Subdivision_type subdivisionType, int depth)
{
...
void Processing_Component::SubdivisionCatmullClark (Polyhedron *pMesh, int depth)
{
	CGAL::Subdivision_method_3::CatmullClark_subdivision(*pMesh,depth);
}

void Processing_Component::SubdivisionLoop (Polyhedron *pMesh, int depth)
{
	CGAL::Subdivision_method_3::Loop_subdivision(*pMesh,depth);
}

void Processing_Component::SubdivisionDooSabin (Polyhedron *pMesh, int depth)
{
	CGAL::Subdivision_method_3::DooSabin_subdivision(*pMesh,depth);
}

void Processing_Component::SubdivisionSqrt3 (Polyhedron *pMesh, int depth)
{
...
void Processing_Component::SubdivisionMidpoint (Polyhedron *pMesh, int depth)
{
