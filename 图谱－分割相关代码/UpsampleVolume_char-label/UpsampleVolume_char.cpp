...
int main( int argc, char * argv[] )
{
  ...
  typedef char T_InputPixel;
  typedef char T_OutputPixel;
  ...
  typedef itk::NearestNeighborInterpolateImageFunction<T_Image, double> T_Interpolator;
  ...
  _pResizeFilter->SetDefaultPixelValue( 0 ); // value for regions without source
